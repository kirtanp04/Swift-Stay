...
export class Redis {
    ...
    private PublishChannelName: string = 'PublishAdminChatMess'; // channel for admin to get user messages
    private SubscribeChannelName: string = 'GetUserChatMess'; // channel for user to get admin messages

    private isConnected: boolean = false;
    private isSubscribed: boolean = false; // Prevent duplicate subscription
