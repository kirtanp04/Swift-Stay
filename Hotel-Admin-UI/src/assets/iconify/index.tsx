...
export function ProfitDecreaseIcon({ IconColor, ...other }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function ProfitIncreaseIcon({ IconColor, ...other }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function JobIcon({ IconColor, ...other }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
